...
/* Function to print the "Lost Wallet Mystery" story
    1. Display a header for the story
    2. Print the story details using the user's name
*/
...
void roadTrip(string userName) {
    ...
    cout << "And finally, just as the sun started setting—Alex pulled into the last place " << userName << " ever expected." << endl;
    ...
    cout << userName << " blinked. He hadn\"t realized how much he needed this. Sometimes, the best trips aren\'t planned." << endl;
}

/*Function to display the menu and get the user's selection
    1. Print the menu options
    2. Get input from the user and return their selection
*/
int menu(){
    cout << "--------MENU---------" << endl;
    cout << "1) \"The Lost Wallet Mystery\" - You misplaced your wallet, but something isn\'t adding up. Every clue leads to a stranger twist. By the end, you\'re uncovering secrets you never meant to find." << endl;
...
int main(){
    /*
      ...
      2. Display the menu and get the user's selection
      3. If the selection is not 4 (exit), display the corresponding story
      4. Repeat until the user selects Exit Program (4)
    */
    ...
    while (menuSelection != 4){
        ...
        // After showing the story, display the menu again for a new selection
        menuSelection = menu();
    }
